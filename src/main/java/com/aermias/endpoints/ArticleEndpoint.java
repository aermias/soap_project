...
import com.aermias.article_ws.AddArticleRequest;
import com.aermias.article_ws.AddArticleResponse;
import com.aermias.article_ws.ArticleInfo;
import com.aermias.article_ws.DeleteArticleRequest;
import com.aermias.article_ws.DeleteArticleResponse;
import com.aermias.article_ws.GetAllArticlesResponse;
import com.aermias.article_ws.GetArticleByIdRequest;
import com.aermias.article_ws.GetArticleByIdResponse;
import com.aermias.article_ws.ServiceStatus;
import com.aermias.article_ws.UpdateArticleRequest;
import com.aermias.article_ws.UpdateArticleResponse;
import com.aermias.service.IArticleService;
...
public class ArticleEndpoint {
	...
	public GetAllArticlesResponse getAllArticles() {
		...
		for (int i = 0; i < articleList.size(); i++) {
			...
			BeanUtils.copyProperties(articleList.get(i), aI);
			articleInfoList.add(aI);    
		}
